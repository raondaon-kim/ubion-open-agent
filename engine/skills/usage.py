...
# Original: https://github.com/NousResearch/hermes-agent/blob/b06e9993021a8eebd891fc60d52372446315b2f0/tools/skill_usage.py
# Modifications:
#   - Initial vendor copy on 2026-05-13 (sandbox/skill-loop-port).
#   - 2026-05-13: Promoted to engine/skills/usage.py.
#     Single import line changed from `from hermes_constants import get_hermes_home`
#     to `from engine.storage.agent_home import get_hermes_home`. No other
