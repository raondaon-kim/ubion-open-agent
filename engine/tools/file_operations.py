#!/usr/bin/env python3
# Vendor copy from NousResearch/hermes-agent (MIT). Two import lines
# rewritten: tools.binary_extensions + agent.file_safety → engine.* eq.
# The module-level docstring example still references `tools.terminal_tool`
# but it's not executable code — just guidance.
"""
...
from engine.tools.binary_extensions import BINARY_EXTENSIONS

from engine.tools.file_safety import (
