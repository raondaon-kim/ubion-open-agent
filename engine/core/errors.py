...
# Original: https://github.com/NousResearch/hermes-agent/blob/b06e9993021a8eebd891fc60d52372446315b2f0/agent/error_classifier.py
# Modifications:
#   - Initial vendor copy on 2026-05-13 (Phase 1 Unit 2).
#   - No code changes. stdlib-only imports.
#
