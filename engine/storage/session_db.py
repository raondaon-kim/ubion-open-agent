...
# Original: https://github.com/NousResearch/hermes-agent/blob/b06e9993021a8eebd891fc60d52372446315b2f0/hermes_state.py
# Modifications: 2 import lines rewritten to engine.* equivalents.
#   - agent.memory_manager  -> engine.learning.memory_manager  (sanitize_context)
#   - hermes_constants       -> engine.storage.agent_home        (get_hermes_home)
...
from engine.learning.memory_manager import sanitize_context
