...
# Original: https://github.com/NousResearch/hermes-agent/blob/b06e9993021a8eebd891fc60d52372446315b2f0/agent/context_compressor.py
# Modifications: import paths rewritten to engine.* equivalents (4 lines).
#   - agent.auxiliary_client  -> engine.llm.aux_client  (call_llm, _is_connection_error)
#   - agent.context_engine    -> engine.learning.context_engine  (ContextEngine)
#   - agent.model_metadata    -> engine.learning.model_metadata  (3 symbols)
#   - agent.redact            -> engine.learning.redact          (redact_sensitive_text)
...
from engine.llm.aux_client import call_llm, _is_connection_error
from engine.learning.context_engine import ContextEngine
